        ...
        <div class="container"><a class="navbar-brand js-scroll-trigger" href="./">puce.io</a><button class="navbar-toggler navbar-toggler-right text-uppercase bg-primary text-white rounded" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive"
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1" role="presentation"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="./documentation.html">documentation</a></li>
                    ...
                    <li class="nav-item mx-0 mx-lg-1" role="presentation"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="./register.html">sign up</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <header class="masthead bg-primary text-white text-center">
        <div class="container"><img class="img-fluid d-block mx-auto mb-5" src="assets/img/login.png">
            <h1>Enter Your Account</h1>
            <hr class="star-light">
            <h2 class="font-weight-light mb-0">Use And Abuse Everything We Have To Offer</h2>
        </div>
    </header>
    <section id="login">
        <div class="container">
            <h2 class="text-uppercase text-center text-secondary mb-0">sign IN</h2>
            <hr class="star-dark mb-5">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <form method="post" id="loginForm" name="sentLogin" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            <div class="form-check mb-3"><input class="form-check-input" type="checkbox" name="remember" value="remember" required="" id="formCheck-1"><label class="form-check-label" for="formCheck-1">Remember-me</label></div>
                        </div>
                        <div id="success"></div>
                        <div class="form-group"><button class="btn btn-primary btn-xl" type="submit" id="sendRegisterButton">Access Account</button></div>
                    </form>
                </div>
            </div>
        </div>
